...
export class RedisService {
    ...
    async get(key: string, db: number = 0) : Promise<ResultType>{
    ...
    async getKeysLike(pattern: string, db: number = 0) : Promise<ResultType>{
    ...
    async deleteKeysLike(pattern: string, db: number = 0) : Promise<ResultType>{
    ...
    async deleteKey(key: string, db: number = 0) : Promise<ResultType>{
    ...
    async setex(key: string, value: string, expiration: number, db: number = 0) {
    ...
    async setSADD(key: string, values: string | string[], db: number = 0) : Promise<boolean> {
    ...
    async getSADD(key: string, db: number = 0) : Promise<ResultType>{
    ...
    async existInList(key: string, value: string, db: number = 0) : Promise<boolean>{
